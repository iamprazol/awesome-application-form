	...
	<form action="/" id="awesome-application-form" method="POST">
		...
		<div class="aaf-form-row">
			<div class="aaf-input-row">
				<label for="first_name" class="aaf-label"><?php esc_html_e( 'First Name', 'awesome-application-form' ); ?></label>
				<input type="text" class="input-text aaf-frontend-field" id="first_name" name="first_name">
			</div>

			<div class="aaf-input-row">
				<label for="last_name" class="aaf-label"><?php esc_html_e( 'Last Name', 'awesome-application-form' ); ?></label>
		...
		<div class="aaf-form-row">
			<div class="aaf-input-row">
				<label for="user_email" class="aaf-label"><?php esc_html_e( 'Email', 'awesome-application-form' ); ?></label>
				<input type="email" class="input-text aaf-frontend-field" id="user_email" name="user_email">
			</div>
			<div class="aaf-input-row">
				<label for="user_address" class="aaf-label"><?php esc_html_e( 'Present Address', 'awesome-application-form' ); ?></label>
		...
		<div class="aaf-form-row">
			<div class="aaf-input-row">
				<label for="user_phone" class="aaf-label"><?php esc_html_e( 'Mobile No', 'awesome-application-form' ); ?></label>
		...
		<div class="aaf-form-row">
			<div class="aaf-input-row">
				<label for="post_name" class="aaf-label"><?php esc_html_e( 'Post Name', 'awesome-application-form' ); ?> (1 - 5)</label>
